#!/bin/bash
#SBATCH --job-name=vanilla_ckpt_freq1000
...
#SBATCH --output=/iopsstor/scratch/cscs/%u/vanilla_ckpt_freq1000_%j.out
#SBATCH --error=/iopsstor/scratch/cscs/%u/vanilla_ckpt_freq1000_%j.err
...
python3 train.py --log-loss-to-csv --experiment_name=vanilla_ckpt_freq1000 --checkpoint-frequency $CHECKPOINT_FREQ --training-steps $TRAINING_STEPS --logging-frequency $LOGGING_FREQ --batch-size=$GLOBAL_BATCH_SIZE
"
