#!/bin/bash
#SBATCH --job-name=vanilla_ckpt_freq500
...
#SBATCH --output=/iopsstor/scratch/cscs/%u/vanilla_ckpt_freq500_%j.out
#SBATCH --error=/iopsstor/scratch/cscs/%u/vanilla_ckpt_freq500_%j.err
...
python3 train.py --log-loss-to-csv --experiment_name=vanilla_ckpt_freq500 --checkpoint-frequency $CHECKPOINT_FREQ --training-steps $TRAINING_STEPS --logging-frequency $LOGGING_FREQ --batch-size=$GLOBAL_BATCH_SIZE
"
