#!/bin/bash
#SBATCH --job-name=baseline_no_ckpt
...
#SBATCH --output=/iopsstor/scratch/cscs/%u/baseline_no_ckpt_%j.out
#SBATCH --error=/iopsstor/scratch/cscs/%u/baseline_no_ckpt_%j.err
...
python3 train.py --log-loss-to-csv --experiment_name=baseline_no_ckpt --training-steps $TRAINING_STEPS --logging-frequency $LOGGING_FREQ --batch-size=$GLOBAL_BATCH_SIZE"
