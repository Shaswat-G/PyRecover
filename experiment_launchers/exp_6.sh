#!/bin/bash
#SBATCH --job-name=dist_ckpt_freq250
...
#SBATCH --output=/iopsstor/scratch/cscs/%u/dist_ckpt_freq250_%j.out
#SBATCH --error=/iopsstor/scratch/cscs/%u/dist_ckpt_freq250_%j.err
...
# run the script
python3 train.py --distributed --use-torch-distributed-ckpt --log-loss-to-csv --experiment_name=dist_ckpt_freq250 --checkpoint-frequency $CHECKPOINT_FREQ --training-steps $TRAINING_STEPS --logging-frequency $LOGGING_FREQ --batch-size=$GLOBAL_BATCH_SIZE
"
